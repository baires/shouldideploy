    ...
    (
      <div
        style={{
          ...
          background: shouldIDeployColorTheme(time, theme)
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <span
            style={{
              ...
              fontSize: 20,
              fontWeight: 400,
              color: shouldIDeployFontTheme(time, theme)
            }}
          >
            shouldideploy.today
          </span>
